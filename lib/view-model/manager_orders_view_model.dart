...
class ManagerOrdersViewModel extends BaseModel{
  ...
  String selectedStatus = ''; // the status selected by the manager to update the order status
  ...
  void loadSelectedOrderClients(){
    _selectedOrderClients = orderClients; // to be fetched from db based on selected order
    // notifyListeners();
  }
